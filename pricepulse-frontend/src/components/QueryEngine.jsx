  ...
  return (
    <div className="space-y-6">
      <motion.div 
        ...
        className="bg-white dark:bg-[#0f1115] border border-slate-200/60 dark:border-white/5 rounded-[2rem] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-2xl relative overflow-visible group transition-all duration-500"
      >
